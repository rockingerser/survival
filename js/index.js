...
function start() {
    ...
    try {
        ...
        document.body.replaceChild(canvas, document.getElementById('game'));
        ...
        function draw() {
            ...
            rqstAnimFrame = requestAnimFrame(draw);
        }
        draw();
        ...
        t.innerHTML = `<h1>EXCEPTION OCCURRED!</h1><p>${e}</p>`
        document.body.replaceChild(t, canvas);
    }
}