!function() {
    ...
    function showHealth(o) {
    	c.drawBar(o.x - (o.r * 1.5), o.y - (o.r * 1.5), o.r * 3, o.r / 4, 'lime', Math.max(0, o.h / o.mh), 1, 'black');
    }
    class Enemy {
        ...
        step() {
            ...
            var shoot = function(o, sp, pres) {
            	enemies.push(new Bullet(o.c,o.x,o.y,o.r / 3,sp,o.dir, 0, typeShot, o.c.fillStyle, pres));
            }
            
            var color = Math.floor((0xff7429 + this.offsetColor) % 2 ** 24).toString(16);
        	...
        	if (this.colchan < colchanTime && this.colchan <= 0)
            ...
            if (Math.random() * 500 <= 1) {
                ...
                if (this.type === 1) {
                	...
                	for (var i = 0; i < nshots; i++) {
                		shoot(this, this.v * 6.3333333333333333, 0.1);
                	}
                } else
                    shoot(this, this.v * 10.3333333333333333, 0.01);
            }
            ...
            if (this.type === 1) {
            	if (this.lh === this.h && this.lh <= this.h && canMove(this))
            ...
            if (this.t === 0)
                if (colliding(this, player)) {
                    ...
                    if (this.val === 0) {
                        ...
                        stun(player, Math.ceil(this.r / 2.6666666666666666 * 1 * 60));this.destroy = true;
                }
                ...
                for (let en of ens)
                    ...
                    stun(en, Math.ceil(this.r / 2.6666666666666666 * 1 * 60));this.destroy = true;
                    }
            }
            if (collidingEdges(this) || this.destroy)
                deleteMe(this);
            this.c.strokeStyle = this.c.fillStyle = this.color;//'tomato';
    ...
    function draw() {
        ...
        var maxv = (player.maxv * ((sprinting * 3) + 1)) / 5;
            if (Math.abs(player.vx) > maxv)
            	player.vx += ((maxv * ((player.vx > 0) * -2 + 1)) - player.vx) / 10;
            if (Math.abs(player.vy) > maxv)
            	player.vy += ((maxv * ((player.vy > 0) * -2 + 1)) - player.vy) / 10;
        ...
        if (player.lh !== player.h && player.lh > player.h) {
        	...
        	if (player.colchan < colchanTime && player.colchan <= 0)
